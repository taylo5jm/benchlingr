...
test_that("Check that .list_api_contents.R generates an appropriate list of entities when given a valid input for contents", {
  expect_type(.list_api_contents(contents = "all"),
              "list")
  expect_type(.list_api_contents(contents = "entity schema"),
              "list")
  expect_type(.list_api_contents(contents = "list contents"),
              "list")
  expect_type(.list_api_contents(contents = "single-get endpoint"),
              "list")
  expect_type(.list_api_contents(contents = "bulk-get endpoints"),
              "list")
})