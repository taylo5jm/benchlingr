...
# that is neither a database connection object nor PqConnection-class
conn2 <- "object"
...
# test case 3 - checking if the function errors out when provided with an input
# that is PqConnection-class but not a database connection object
conn3 <- "object"
...
# test case 4 - checking if the function errors out when provided with an input
...
# test case 5 - checking if the function errors with an informative message 
